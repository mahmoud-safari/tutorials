...
print('prune.random_unstructured(module, name="weight", amount=0.3) applied')
...
print('prune.l1_unstructured(module, name="bias", amount=3) applied')
...
print('prune.ln_structured(module, name="weight", amount=0.5, n=2, dim=0) applied')
...
new_model = LeNet()
# print('new_model.named_modules() =', new_model.named_modules())
